...
function addMultiChooseQuizElement() {
    ...
    var obj = "<div id='" + elId + "' node='obj' objType='" + COMP_TYPE_1 + "' pageId='" + currentPage.pageId + "' onclick='changeSelection($(this))' data-moveable class=\"content quiz_area\" style=\"left: 101px; top: 324px; width: 450px; height: 200px; cursor: pointer;\">" +
        ...
        "                      <span class=\"multiple-icon\" style=\"left: 14px; top: 50%;\"><img src=\"./asset/theme/curious_blue/quiz/quiz_choice_user.svg\" width=\"16\"></span>" +
        ...
        "                      <span class=\"multiple-icon\" style=\"left: 14px; top: 50%;\"><img src=\"./asset/theme/curious_blue/quiz/quiz_choice_answer.svg\" width=\"16\"></span>" +
        ...
        "                      <span class=\"multiple-icon\"><img src=\"./asset/theme/curious_blue/quiz/quiz_choice_user.svg\" width=\"16\"></span>" +
...
function addDrawLineQuizElement() {
    ...
    var obj = "<div id='" + elId + "' node='obj' objType='" + COMP_TYPE_3 + "' pageId='" + currentPage.pageId + "' onclick='changeSelection($(this))' data-moveable class=\"content quiz_area\" style=\"left: 101px; top: 324px; width: 450px; height: 200px; cursor: pointer;\">" +
        ...
        "  <ul class=\"dot-items\"><li class=\"sub-item dot start\"  style=\"left: 98.2527px; top: 68.7769px; width: 10.8078px; height: 10.8078px;\">" +
        "          <img src=\"./asset/theme/curious_blue/quiz/quiz_line_dot.svg\" width=\"10.8078005\" height=\"10.8078005\">" +
        "        " +
        "        <div class=\"object_outline \" style=\"display: none; width: 100%; height: 100%;\">" +
        "          <span class=\"box_outlines border_solid\"><span></span><span></span><span></span><span></span></span>" +
        "        </div></li><li class=\"sub-item dot start\"  style=\"left: 98.2527px; top: 117.903px; width: 10.8078px; height: 10.8078px;\">" +
        "          <img src=\"./asset/theme/curious_blue/quiz/quiz_line_dot.svg\" width=\"10.8078005\" height=\"10.8078005\">" +
        "        " +
        "        <div class=\"object_outline \" style=\"display: none; width: 100%; height: 100%;\">" +
        "          <span class=\"box_outlines border_solid\"><span></span><span></span><span></span><span></span></span>" +
        "        </div></li><li class=\"sub-item dot start\"  style=\"left: 98.2527px; top: 167.03px; width: 10.8078px; height: 10.8078px;\">" +
        "          <img src=\"./asset/theme/curious_blue/quiz/quiz_line_dot.svg\" width=\"10.8078005\" height=\"10.8078005\">" +
        "        " +
        "        <div class=\"object_outline \" style=\"display: none; width: 100%; height: 100%;\">" +
        "          <span class=\"box_outlines border_solid\"><span></span><span></span><span></span><span></span></span>" +
        "        </div></li><li class=\"sub-item dot end\"  style=\"left: 294.758px; top: 68.7769px; width: 10.8078px; height: 10.8078px;\">" +
        "          <img src=\"./asset/theme/curious_blue/quiz/quiz_line_dot.svg\" width=\"10.8078005\" height=\"10.8078005\">" +
        "        " +
        "        <div class=\"object_outline \" style=\"display: none; width: 100%; height: 100%;\">" +
        "          <span class=\"box_outlines border_solid\"><span></span><span></span><span></span><span></span></span>" +
        "        </div></li><li class=\"sub-item dot end\"  style=\"left: 294.758px; top: 117.903px; width: 10.8078px; height: 10.8078px;\">" +
        "          <img src=\"./asset/theme/curious_blue/quiz/quiz_line_dot.svg\" width=\"10.8078005\" height=\"10.8078005\">" +
        "        " +
        "        <div class=\"object_outline \" style=\"display: none; width: 100%; height: 100%;\">" +
        "          <span class=\"box_outlines border_solid\"><span></span><span></span><span></span><span></span></span>" +
        "        </div></li><li class=\"sub-item dot end\" style=\"left: 294.758px; top: 167.03px; width: 10.8078px; height: 10.8078px;\">" +
        "          <img src=\"./asset/theme/curious_blue/quiz/quiz_line_dot.svg\" width=\"10.8078005\" height=\"10.8078005\">" +
        "        " +
        "        <div class=\"object_outline \" style=\"display: none; width: 100%; height: 100%;\">" +
        "          <span class=\"box_outlines border_solid\"><span></span><span></span><span></span><span></span></span>" +
...
function addDragDropQuizElement() {
    ...
    var obj = "<div id='" + elId + "' node='obj' objType='" + COMP_TYPE_5 + "' pageId='" + currentPage.pageId + "' onclick='changeSelection($(this))' data-moveable class=\"content quiz_area\" style=\"left: 101px; top: 324px; width: 450px; height: 200px; cursor: pointer;\">" +
        "<div class=\"handle ui-draggable\" style=\"left: 0px; top: 0px; width: 442.125px; height: 177.813px;\">" +
        "        <div class=\"object_outline main\" style=\"display: none; width: 100%; height: 100%;\">" +
        "          <span class=\"box_outlines border_solid\"><span></span><span></span><span></span><span></span></span>" +
        "        </div></div>" +
...
function addStickerElement() {
    ...
    var obj = "<div id='" + elId + "' node='obj' objType='" + COMP_TYPE_6 + "' pageId='" + currentPage.pageId + "' onclick='changeSelection($(this))' data-moveable class=\"content droppable quiz_area\" style=\"left: 101px; top: 200px; width: 450px; height: 450px; cursor: pointer;\">" +
        "<div class=\"btn replay sub-item\" style=\"visibility: visible; left: 412.661px; top: 0px; width: 29.4758px; height: 29.4758px;\">" +
        "    <img src=\"./asset/theme/curious_blue/quiz/quiz_btn_replay.svg\" width=\"29.4758195\" height=\"29.4758195\" alt=\"다시 풀기\">" +
        "</div> " +
        ...
        "    <img src=\"./asset/img/quiz/sticker_drop.svg\" style=\"width: 42px; height: 42px;\" alt=\"drop\">" +
        "</div>" +
...
function addCheckboxElement() {
    ...
    var obj = '<div draggable="true" id="' + elId + '" node="obj" objType="' + COMP_TYPE_7 + '" pageId="' + currentPage.pageId + '" onclick="changeSelection($(this))" data-moveable class="draggable textElement" style="left:150px; top:150px; width: 320px; height: 200px; ">' +
        ' <div style="height:100%; width:100%; position:relative; ">' +

        '<div class="" style="position:relative; text-align:end;">' +
        ' <img src = "./asset/theme/curious_blue/quiz/quiz_btn_replay.svg" style="width:50px;" alt = "다시 풀기" >' +
    ...
    addElement(newObj)
    addDraggable($('#' + elId), isResizable = true)
    changeSelection(obj)
}


function tabClick(ev) {
    $(".tab-controller-container .tab-controller.active").removeClass("active");
    $(".tab-content.active").removeClass("active");
    var element = ev.target;
    var tabControlValue = element.getAttribute('tab-control');
    var activeContent = document.getElementById(tabControlValue)
    activeContent.classList.add("active");
    $(ev.target).addClass('active');
}


function addTabElement() {
    var elId = makeid('tab', 10);
    var obj = '<div  id="' + elId + '" node="obj" objType="' + COMP_TYPE_8 + '" pageId="' + currentPage.pageId + '"  data-moveable class="draggable textElement" style="left:150px; top:150px; width: 320px; height: 200px; cursor: pointer;">' +
        ' <div class="tab-container" id="tab-container"  style="height:100%; width:100%; position:relative; ">' +
        '<div class="tab-controller-container" >' +
        ' <div class="tab-controller" onclick="tabClick(event)" tab-control="tab-1" >Tab 1</div>' +
        ' <div class="tab-controller"onclick="tabClick(event)" tab-control="tab-2">Tab 2</div>' +
        '</div>' +
        '<div class="tab-content active" id="tab-1" onclick="changeSelection($(this))">' +
        'tab-1' +
        '</div>' +
        '<div class="tab-content" id="tab-2" onclick="changeSelection($(this))">' +
        'tab-2' +
        '</div>'
    '</div>'
    mainPage.prepend(obj);

    var newObj = {
        pageId: currentPage.pageId,
        id: elId,
        objType: COMP_TYPE_8, // It seems this line is not updated, you may want to adjust it accordingly
        datas: {},
        style: {
            left: "150",
            top: "150",
